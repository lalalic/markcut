...
- component isBackground:true
  ~~~jsx
  <div style={{fontSize:48,color:'#fff',padding:40}}>
  机器学习导论
  <br/>Introduction to Machine Learning
  <br/><strong>Dr. AI</strong> | 人工智能入门课程
  </div>
  ~~~
...
- parallel
  - component isBackground:true
    ~~~jsx
    <div style={{fontSize:28,padding:40,color:'#fff'}}>
    <strong>什么是机器学习？</strong>
    <br/>- 🤖 从数据中学习规律 — 无需人工编写规则
    <br/>- 📊 数据驱动 — 从样本中自动总结模式
    <br/>- 🔄 持续改进 — 更多数据 = 更好表现
    </div>
    ~~~
...
- component isBackground:true
  ~~~jsx
  <div style={{fontSize:28,padding:40,color:'#fff'}}>
  <strong>监督学习</strong><br/>Supervised Learning
  <br/>- 🏷️ 标注数据训练 — 每个样本都有正确答案
  <br/>- 🔗 输入→输出映射 — 学习特征到标签的函数
  <br/>- 📋 典型应用：垃圾邮件检测、房价预测、医学诊断
  <br/>- ⚡ 核心算法：线性回归、决策树、SVM、神经网络
  </div>
  ~~~
...
- component isBackground:true
  ~~~jsx
  <div style={{fontSize:28,padding:40,color:'#fff'}}>
  <strong>无监督学习</strong><br/>Unsupervised Learning
  <br/>- 🧩 无标签数据 — 让数据自己"说话"
  <br/>- 🔍 发现隐藏结构 — 模式、群组、关联规则
  <br/>- 📋 典型应用：客户分群、异常检测、推荐系统
  <br/>- 💡 核心思想：从混沌中发现秩序
  </div>
  ~~~
...
- component isBackground:true
  ~~~jsx
  <div style={{fontSize:28,padding:40,color:'#fff'}}>
  <strong>强化学习</strong><br/>Reinforcement Learning
  <br/>- 🎮 智能体 + 环境 + 奖励 — 三位一体
  <br/>- 🔄 试错学习 — 从反馈中不断优化策略
  <br/>- 🏆 里程碑：AlphaGo、OpenAI Five、ChatGPT
  <br/>- 🔬 核心要素：策略网络、价值函数、奖励信号
  </div>
  ~~~
...
- component isBackground:true
  ~~~jsx
  <div style={{fontSize:28,padding:40,color:'#fff'}}>
  <strong>总结</strong><br/>Summary
  <br/>🔵 监督学习 — 标注数据 → 分类/回归
  <br/>🟢 无监督学习 — 无标签数据 → 聚类/降维
  <br/>🟠 强化学习 — 环境交互 → 决策/控制
  <br/><br/>有标注数据？→ 监督学习
  <br/>想发现模式？→ 无监督学习
  <br/>需要自主决策？→ 强化学习
...
- component
  ~~~jsx
  <div style={{fontSize:36,color:'#fff',padding:40}}>
  Q&A<br/>
  Thank You!<br/>
  <span style={{fontSize:24,color:'#888'}}>Contact: ...</span>
  </div>
  ~~~