 ...
 */
export const DEFAULT_VTT_SAMPLE_INTERVAL = 5;
 ...
 */
export const DEFAULT_VTT = 'uvx --from mlx-vlm mlx_vlm.generate --model mlx-community/MiniCPM-V-4.6-bf16 --max-tokens 2048 --prompt "{prompt}" --video {input} --temperature 0.0 --processor-kwargs \'{"max_num_frames": 32, "stack_frames": 1, "max_slice_nums": 1, "use_image_id": false}\'';
 ...
 */
export const DEFAULT_AGENT = 'npx pi -p {prompt}';
